<template>
    ...
    <div class="footer-content">
        ...
        <div class="footer-content-contact">
            ...
            <span class="footer_span">+7 (812) 123-45-67</span>
            <span  class="footer_span">+7 (911) 123-45-67</span>
            <span  class="footer_span">Новоостровский проспект, дом 36 лит. С</span>
        </div>
        <div class="footer-content-operatingMode">
            <h3 class="footer_title">Режим работы</h3>
            <span  class="footer_span">C 10:00 до 21:00 (Пн-Пт)</span>
            <span  class="footer_span">С 11:00 до 20:00 (Сб-Вс)</span>
        </div>
        <div class="footer-content-networks">
            <h3 class="footer_title">Мы в Instagram</h3>
    ...
    <hr >
    <h5 class="footer_copirait">Copyright © 2017 - 2022</h5>
</footer>
